  ...
  return (
    <main className="bg-bone text-ink">
      ...
      <section id="offer" className="section bg-bone paper-grain">
        ...
        <span className="corner-label tr text-ink">100 seats · $59</span>
        <div className="container-wide">
          {/* H1 + intro — top */}
            ...
            <div className="md:col-span-4 md:pb-4">
              <FadeIn delay={0.1}>
                <p className="text-base md:text-lg leading-relaxed text-ink-soft">
                  After these seats are gone, my dear self will be $9.99/month,
                  $69/year, or $199 for a fully done-for-you setup. The
            ...
            <FadeIn delay={0.3}>
              <div className="mt-12 text-center space-y-4">
                ...
                <p
                  ...
                  style={{ fontSize: "var(--text-display-sm)" }}
                >
                  Lifetime access for less than six months of the regular plan.
                </p>
              </div>
            </FadeIn>
